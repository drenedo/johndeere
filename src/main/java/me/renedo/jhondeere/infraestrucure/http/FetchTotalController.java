package me.renedo.jhondeere.infraestrucure.http;
...
import me.renedo.jhondeere.application.FetchTotalsUseCase;
import me.renedo.jhondeere.application.Total;
...
public class FetchTotalController {
    ...
    @GetMapping(value = "/total/machine/{machineId}/session/{sessionId}")
